const CACHE = "kyushu-private-v5.0.0";
const SHELL = [
  "./","./index.html","./style.css?v=500","./app.js?v=500",
  "./manifest.json","./firebase-config.js?v=430","./icon-192.png","./icon-512.png","./hero-cover-v50.webp?v=500",
